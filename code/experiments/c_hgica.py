...
"""
Train hierarchical Gaussian-ICA mixtures.
"""
...
def main(argv):
	...
	experiment.save('results/c_hgica/c_hgica.0.xpck')
	...
	for layer in range(1, max_layers):
		...
		try:
			experiment.save('results/c_hgica/c_hgica.{0}.{1}.xpck'.format(patch_size, layer))
		except:
			import pdb
			pdb.set_trace()
